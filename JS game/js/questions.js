const questions = [
    ...
    {
        'question' : `When you enter a situation without a definite plan 
        of action, you are said to be "playing it by" what?`,
        'content' : [
            'Fingertips',
            'Ear',
            'Nose',
...
localStorage.setItem('myQuestionsKey', JSON.stringify(questions));